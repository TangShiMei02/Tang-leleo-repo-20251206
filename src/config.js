const config = {
	...
	projectcards: [
		...
		{ go: "📝 前往", img: "https://cdn.magicalapk.com/square/4216147013152665.jpg", title: "本站数据报", subtitle: "用的是51.la统计，还是太好用啦，哈哈哈！", text: "不要再点错啦！点前往哦", url: "https://user.ustat.com/pc/#/website/report?websiteId=019e4a81-1134-726c-bafa-6d0b66f022ea", show: false },  // 51LA路边一条，不用了，我还怕你给我跳转小广告网站呢，用新的这个了，要是最后都不行，我就用GitHub开源的自建数据统计了，这是我的底线了。2026/5/21 22:17  https://v6.51.la/s/4e15gMExaC7sDLm
