const config = {
	...
	projectcards: [
		{ go: "🔍 前往", img: "https://blog.224418.xyz/img/light-background.jpg", title: "傥师妹TangShiMei的小空间", subtitle: "这里是 傥师妹TangShiMei的小空间 ，我的博客，欢迎点进来支持一下啊", text: "摘下最喜欢的麦穗，然后闭着眼走过整片麦田。", url: " https://blog.224418.xyz/  ", show: false },
		...
		{ go: "📝 前往", img: "https://cdn.harmony5.cn/square/22420711313835947.png", title: "本站数据报", subtitle: "用的是umami统计", text: "不要再点错啦！点前往哦", url: "https://cloud.umami.is/share/fya5BXIncGyZXxRV", show: false },  // 51LA路边一条，不用了，我还怕你给我跳转小广告网站呢，用新的这个了，要是最后都不行，我就用GitHub开源的自建数据统计了，这是我的底线了。2026/5/21 22:17  https://v6.51.la/s/4e15gMExaC7sDLm
		...
		{ go: "🎲 前往", img: "https://cdn.magicalapk.com/square/8633393281099456.png", title: "中航大一言", subtitle: "虽然说是中航大一言，但还都是我自己上传的语录罢了，可以当作一个自己的语录集锦，能做api。", text: "用小兔互联的主机弄得一个一言小项目，感觉还不错吧，也是Kimi帮着弄的。——2026/6/3 22:17", url: "https://qvp.cc.cd/yiyan", show: false },
		{ go: "🔗 前往", img: "https://pic.224418.xyz/file/archive/pic/image.png", title: "YOURLS短链", subtitle: "使用的是GitHub开源的YOURLS短链，弄在虚拟主机上面。", text: "弄在虚拟主机上面。——2026/6/329 23:10", url: "https://qvp.cc.cd/s/", show: false },	
		{ go: "💤 前往", img: "https://cdn.harmony5.cn/square/21601474288882511.png", title: "Abbrlink生成器", subtitle: "这个是一个abbrlink生成器", text: "这个是一个abbrlink生成器，就是可以在pagescms在线写文章的时候，用这个随便生成一个链接天刀那个自定义永久链接里面。——2026/6/3 22:11", url: "https://abbrlink-generator.224418.xyz/", show: false },
